      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            represent and warrant that you are 18 years of age or older. The Service is intended for
            adults only and contains content related to adult performance training.
          </p>
          ...
          <p>
            The Service is provided for personal, non-commercial use only. We reserve the right to
            modify, suspend, or discontinue any aspect of the Service at any time without prior
            notice.
          </p>
          ...
          <ul>
            ...
            <li>
              Use the AI coaching feature to generate harmful, illegal, or inappropriate content
            </li>
          ...
          <p>
            The Service includes an AI-powered coaching feature. By using this feature, you
            acknowledge that:
          </p>
          <ul>
            <li>
            ...
            <li>
              The AI is not a substitute for professional medical, psychological, or health advice
            </li>
            ...
            <li>
              We may review AI interactions to improve the Service and ensure compliance with these
              Terms
            </li>
            <li>
              Abuse of the AI feature, including prompt injection attempts, may result in account
              suspension
            </li>
          </ul>
          ...
          <p className="font-semibold">
            THE SERVICE IS NOT A MEDICAL DEVICE AND IS NOT INTENDED TO DIAGNOSE, TREAT, CURE, OR
          ...
          <ul>
            ...
            <li>
              We are not responsible for any health outcomes resulting from use of the Service
            </li>
          </ul>

          <h2>7. Intellectual Property</h2>
          <p>
            The Service and its original content, features, and functionality are owned by Carter
            LaSalle and are protected by copyright, trademark, and other intellectual property laws.
            The source code is available under the MIT License as described on our{' '}
          ...
          <p>
            ...
            grant us a limited license to process and store your data as necessary to provide the
            Service.
          </p>
          ...
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL STAMINA TIMER, ITS OWNER,
            AFFILIATES, OR LICENSORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL,
          ...
          <p>
            You agree to indemnify, defend, and hold harmless Stamina Timer and its owner from and
          ...
          <p>
            The Service may integrate with or contain links to third-party services, including but
            not limited to:
          </p>
          <ul>
          ...
          <p>
            We are not responsible for the practices or content of third-party services. Your use of
            such services is subject to their respective terms and privacy policies.
          </p>
          ...
          <p>
            ...
            deletion feature in Settings. Upon termination, your data will be handled as described
          ...
          <p>
            ...
            material changes by posting the updated Terms on the Service with a new effective date.
          ...
          <p>
            ...
            these Terms shall be resolved through binding arbitration in accordance with applicable
            arbitration rules.
          </p>
          ...
          <p>
            These Terms, together with the Privacy Policy and License, constitute the entire
            agreement between you and Stamina Timer regarding the Service and supersede all prior
